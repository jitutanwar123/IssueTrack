    ...
    <main className="flex min-h-screen items-center justify-center login-bg px-4 py-8">
      ...
      >
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-xs font-semibold uppercase tracking-[0.18em]" style={{ color: "rgba(148,163,184,0.9)" }}>IT Admin Portal</p>
        </div>
        ...
        <form onSubmit={submit} autoComplete="off" className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full rounded-xl px-4 py-2.5 pr-10 text-sm font-medium text-white outline-none transition-all duration-200 placeholder:text-slate-500 focus:ring-2 focus:ring-blue-500/40"
                style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)" }}
              />
              <button
                type="button"
          ...
          {/* Portal links */}
          <div
            className="pt-3 grid grid-cols-1 gap-3 text-sm sm:grid-cols-2 sm:items-center"
            style={{ borderTop: "1px solid rgba(255,255,255,0.08)", color: "rgba(226,232,240,0.82)" }}
          >
