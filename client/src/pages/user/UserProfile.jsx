...
export default function UserProfile() {
  ...
  const stats = [
    ...
    { label: "Open", value: summary?.open ?? 0, color: "text-brand-700", bg: "bg-brand-50" },
    { label: "In Progress", value: summary?.inProgress ?? 0, color: "text-amber-700", bg: "bg-amber-50" },
    { label: "Resolved", value: summary?.resolved ?? 0, color: "text-emerald-700", bg: "bg-emerald-50" },
  ];
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border border-slate-200 bg-slate-900 p-6 text-white shadow-elevated">
        <div className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-300">Account</div>
        <h2 className="mt-2 text-[28px] font-semibold tracking-tight">My Profile</h2>
      ...
      <div className="grid gap-6 xl:grid-cols-[340px_1fr]">
        <div className="space-y-5">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-soft text-center">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-slate-600 to-slate-800 text-2xl font-bold text-white shadow-lg">
              {initials}
            </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-soft overflow-hidden">
            <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
              ...
              <Link to="/user/my-tickets" className="text-sm font-medium text-brand-700 hover:text-brand-800">
                View all →
              </Link>
            </div>
              ...
              {loading ? (
                ...
                <div className="py-10 text-center">
                  ...
                  <Link
                    ...
                    className="mt-3 inline-block rounded-xl bg-brand-700 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-800"
                  >
